...
import { fetchReportReviewVideos, approveVideo, rejectVideo, adminDeleteVideo } from '@/api/admin'
...
async function loadList() {
  loading.value = true
  try {
    const res = await fetchReportReviewVideos(page.value, 10)
...
<template>
  <div class="admin-panel">
    <h1 class="page-title">举报复审</h1>
    <p class="page-subtitle">已发布视频被举报达到 3 次后进入复审队列</p>
    ...
    <el-card v-loading="loading" shadow="never">
      ...
      <el-empty v-if="!loading && !videos.length" description="暂无举报复审视频" />
